...
public class CameraObject extends LevelObject
{
    public CameraObject(ZoneArchive zone, String filepath, Bcsv.Entry entry)
    {
        this.zone = zone;
    ...
    public CameraObject(ZoneArchive zone, String filepath, int game, String objname, Vector3 pos)
    {
        this.zone = zone;
        String[] stuff = filepath.split("/");
        directory = stuff[0];
    ...
    public void getProperties(PropertyGrid panel)
    {
        ...
        panel.addCategory("obj_grav", "Unknown Parameters");
        panel.addField("[50F5D5E6]", "[50F5D5E6]", "int", null, data.get("Unknown 1"));
        panel.addField("[CDC4FEAD]", "[CDC4FEAD]", "int", null, data.get("Unknown 2"));
